...
<div id="header">
    <div class="row">
        ...
        <div class="col-md-8 center top-links">
            <a class="header-link" href="index.php"> In Stock </a>
            <a class="header-link" href="request.php"> Request a Book </a>
            <a class="header-link" href="lookup.php"> Look Up a Request </a>
            <!-- check if logged in and if they are admin, then if yes, display admin link -->
            <?php
                if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
                    if ($_SESSION['is_admin'] == true) {
                        echo '<a class="header-link" href="admin/dashboard.php"> Admin </a>';
                    }
                }
            ?>
